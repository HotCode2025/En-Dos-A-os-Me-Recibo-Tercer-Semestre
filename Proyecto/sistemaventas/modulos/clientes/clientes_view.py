...
class ClientesView(ctk.CTkFrame):
    def __init__(self, master, controlador, clientes):
        ...
        self.entry_search = ctk.CTkEntry(top_frame, placeholder_text="Buscar cliente por razón social o DNI/CUIT...", width=350)
        ...
        self.headers = ["ID", "Razón social", "DNI/CUIT", "Email", "Teléfono", "Dirección", "Compras", "Obs.", "Acciones"]
